            ...
            <div className="flex flex-wrap items-center gap-4 border-b border-[color:var(--hairline)] px-6 min-h-12 py-2.5 shrink-0">
              ...
              {selectedTopicId && (
                <button
                  ...
                  className="ml-auto inline-flex items-center gap-1.5 px-2 py-2 -mx-2 -my-2 text-[11px] text-muted-foreground hover:text-foreground transition-colors tracking-tight rounded-md"
                >
