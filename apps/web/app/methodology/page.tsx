          ...
          <Section number="07" title="Open source">
            ...
            <div className="mt-6">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-foreground bg-transparent pl-4 pr-3.5 py-2.5 text-[13px] font-medium text-foreground hover:bg-foreground/8 transition-colors"
              >
